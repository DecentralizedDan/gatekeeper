 ...
 */
export function decimalToBinary(decimal, bitCount) {
 ...
 */
export function binaryToDecimal(binary, isSigned = false) {
 ...
 */
export function calculateBitCount(decimal, isSigned = false) {
    const absDecimal = Math.abs(decimal);
    if (absDecimal === 0) {
        return 1;
    }
 ...
 */
export function getStepInfo(currentIndex) {
 ...
 */
export function checkAnswer(userBinary, targetDecimal) {
 ...
 */
export function formatBinary(binary, groupSize = 4) {
    const groups = [];
 ...
 */
export function getHint(decimal) {
    if (decimal === 0) {
